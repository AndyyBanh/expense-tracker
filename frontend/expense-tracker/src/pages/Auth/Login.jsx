    ...
    const Login = () => {
        ...
        const handleLogin = async (e) => {
            ...
            try {
                ...
                // save token and redirect user to dashboard for successful login
                if (token) {
        ...
        return (
            <AuthLayout>
                <div className='lg:w-[70%] h-3/4 md:h-full flex flex-col justify-center'>
                    ...
                    {/* Create a form for input component with properties required */}
                    <form onSubmit={handleLogin}>
                        ...
                        <p className='text-[13px] text-slate-800 mt-3'>
                            ...
                            {/* Link to the signup page, styled as underlined and colored */}
